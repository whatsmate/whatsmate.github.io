...
3. Locate the file `bash/send-image-individual.sh`.  <script src="http://gist-it.appspot.com/github/whatsmate/wa-demos/blob/master/bash/send-image-individual.sh?footer=minimal"></script>

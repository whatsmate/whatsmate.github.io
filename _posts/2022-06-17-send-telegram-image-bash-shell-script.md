---
layout: post
title: How to send an image to a Telegram user from shell script
subtitle: Using the WhatsMate Telegram Gateway REST API
published: true
last_modified_at: 2022-06-17T00:00:00+08:00
---

This article shows you how to send an image to a registered Telegram user from a shell script.
...
To send a Telegram message containing an image from a shell script, do this:

1. First, learn how to send a simple text message on the [official site](https://www.whatsmate.net/telegram-gateway-api.html). 
2. With the above knowledge, you can now download our [sample code](https://github.com/whatsmate/telegram-demos/archive/master.zip).
3. Locate the file `bash/send-telegram-image.sh`.  <script src="https://gist.github.com/whatsmate/806e319ac49a980045bb3e2d4c6da050.js"></script>
...
6. Run the script to send yourself the first image: `./send-telegram-image.sh`

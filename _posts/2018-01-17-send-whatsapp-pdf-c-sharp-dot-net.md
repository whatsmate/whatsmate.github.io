---
layout: post
title: How to send a PDF file to a WhatsApp user in C# (.NET) using Visual Studio 2019
subtitle: Using the WhatsMate WhatsApp Gateway REST API
published: true
last_modified_at: 2026-01-28T20:11:00+08:00
---

This article shows you how to send a document (e.g. a PDF file, an MP4 file, a WAV file, etc.) to a registered WhatsApp user in Microsoft's .NET language: C# using Visual Studio 2019.

If you are using Visual Studio 2022, please read [this tutorial](/2022-07-18-send-whatsapp-pdf-c-sharp-dot-net-vs2022/) instead.
...
3. Locate the file `cs/send-pdf-individual.cs`.  <script src="https://gist.github.com/whatsmate/93ed36e28cbc73495d6ad1862cf61193.js"></script>

...
1. Copy the following source code to your PowerShell script.  <script src="https://gist.github.com/whatsmate/4fb2ac1e3aebc188f977088b96325838.js"></script>
2. Specify your target recipient on line 1. Remember to include the country code.
3. Specify your message on line 2.
4. Run the script in PowerShell to send your message: `.\send-telegram.ps1`

---
layout: post
title: How to send a PDF file to a WhatsApp user in Python 3
subtitle: Using the WhatsMate WhatsApp Gateway REST API
published: true
last_modified_at: 2020-02-22T00:00:00+08:00
---

This article shows you how to send a document (e.g. a PDF file, an MP4 file, a WAV file, etc.) to a registered WhatsApp user in Python 3.
...
To send a WhatsApp message containing a PDF document in Python 3, do this:
...
3. Locate the file `python3/send-pdf-individual.py`.  <script src="https://gist.github.com/whatsmate/dd8a28d584bc9e8155f42b85e837702a.js"></script>
